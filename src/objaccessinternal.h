...
#define READ_UNS32(objDict, index, subIndex)\
    (objDict[index].pSubindex[subIndex].bAccessType != CONST ? *(UNS32*)objDict[index].pSubindex[subIndex].pObject : *(const UNS32*)objDict[index].pSubindex[subIndex].pObjectConst)

#define READ_UNS16(objDict, index, subIndex)\
    (objDict[index].pSubindex[subIndex].bAccessType != CONST ? *(UNS16*)objDict[index].pSubindex[subIndex].pObject : *(const UNS16*)objDict[index].pSubindex[subIndex].pObjectConst)

#define READ_UNS8(objDict, index, subIndex)\
    (objDict[index].pSubindex[subIndex].bAccessType != CONST ? *(UNS8*)objDict[index].pSubindex[subIndex].pObject : *(const UNS8*)objDict[index].pSubindex[subIndex].pObjectConst)
