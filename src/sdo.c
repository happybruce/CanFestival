...
UNS8 serverDownloadSegData();
UNS8 clientUploadSegData();
...
UNS8 proceedSDO(CO_Data* d, Message* m)
{
    ...
    //         }
    //         /* Looking for the cobid received. */
    //         if (READ_UNS32(d->objdict, offset, 1) == msgCobId )
    //         {
    //             whoami = SDO_SERVER;
    ...
    //             }
    //             /* Looking for the cobid received. */
    //             if (READ_UNS32(d->objdict, offset, 2) == msgCobId )
    //             {
    //                 whoami = SDO_CLIENT;
