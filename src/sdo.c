...
#define RestartSDO_TIMER(line) \
    MSG_WAR(0x3A07, "restartSDO_TIMER for line : ", line);\
if(d->transfers[line].timer != TIMER_NONE) { StopSDO_TIMER(line) StartSDO_TIMER(line) }
